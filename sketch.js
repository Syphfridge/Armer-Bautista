...
function setup() {
  ...
  modeSelect.option("Simple mode", "kids"); // label changed
...
function drawParameterText(
  ...
  if (mode === "kids") {
    ...
    y += 18;
    text("The black dot shows a fair price and quantity.", x0, y);
    y += 22;
...
function positionWatermark() {
  ...
  // Stick to the very bottom-right of the window with a small margin
